...
__onRebuildObservable = null;
        ...
        public async ValueTask<PickingInfo> intersects(Ray ray, System.Nullable<bool> fastCheck = null, TrianglePickingPredicate trianglePredicate = null)
        {
...
// getFacetLocalPartitioning is not supported by the platform yet
        ...
        public async ValueTask<AbstractMesh> enableEdgesRendering(System.Nullable<decimal> epsilon = null, System.Nullable<bool> checkVerticesInsteadOfIndices = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<AbstractMesh>(
                entity => new AbstractMesh() { ___guid = entity.___guid },
                new object[] 
