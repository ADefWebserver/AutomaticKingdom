...
__style = null;
        ...
        public async ValueTask<AbstractMesh> get_linkedMesh()
        {
            if(__linkedMesh == null)
            {
                __linkedMesh = await EventHorizonBlazorInterop.GetClass<AbstractMesh>(
                    this.___guid,
                    "linkedMesh",
                    (entity) =>
                    {
...
__onAfterDrawObservable = null;
        ...
        public async ValueTask linkWithMesh(AbstractMesh mesh)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
