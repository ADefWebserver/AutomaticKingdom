...
namespace BabylonJS.GUI
{
    ...
    public class AdvancedDynamicTexture : DynamicTexture
    {
        ...
        public static async ValueTask<AdvancedDynamicTexture> CreateForMesh(AbstractMesh mesh, System.Nullable<decimal> width = null, System.Nullable<decimal> height = null, System.Nullable<bool> supportPointerMove = null, System.Nullable<bool> onlyAlphaTesting = null)
        {
...
__onEndRenderObservable = null;
        ...
        public async ValueTask<string> executeOnAllControls(
            Func<Control, Task> callback
        )
        {
            await SetupExecuteOnAllControlsLoop();
        ...
        private async ValueTask SetupExecuteOnAllControlsLoop()
        {
