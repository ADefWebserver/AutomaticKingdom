...
namespace BabylonJS
{
    ...
    public class Observable<T> : CachedEntityObject where T : CachedEntity, new()
    {
        ...
        public async ValueTask<bool> notifyObservers(T eventData, System.Nullable<decimal> mask = null, object target = null, object currentTarget = null)
        {
            return await EventHorizonBlazorInterop.Func<bool>(
                new object[] 
                {
        ...
        public async ValueTask notifyObserversWithPromise(T eventData, System.Nullable<decimal> mask = null, object target = null, object currentTarget = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
