...
namespace BabylonJS
{
    ...
    public class SubMesh : BaseSubMesh, ICullable
    {
        ...
        public async ValueTask<IntersectionInfo> intersects(Ray ray, Vector3[] positions, decimal[] indices, System.Nullable<bool> fastCheck = null, TrianglePickingPredicate trianglePredicate = null)
        {
