...
__morphTargetManager = null;
        ...
        public async ValueTask<string> updateMeshPositions(
            Func<decimal[], Task> callback
        )
        {
            await SetupUpdateMeshPositionsLoop();
        ...
        private async ValueTask SetupUpdateMeshPositionsLoop()
        {
        ...
        public async ValueTask<string> optimizeIndices(
            Func<Mesh, Task> callback
        )
        {
            await SetupOptimizeIndicesLoop();
        ...
        private async ValueTask SetupOptimizeIndicesLoop()
        {
