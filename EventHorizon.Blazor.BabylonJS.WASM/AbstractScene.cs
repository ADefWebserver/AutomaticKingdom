...
namespace BabylonJS
{
    ...
    public class AbstractScene : CachedEntityObject
    {
        ...
        public static async ValueTask AddParser(string name, BabylonFileParser parser)
        {
        ...
        public static async ValueTask<BabylonFileParser> GetParser(string name)
        {
            return await EventHorizonBlazorInterop.FuncClass<BabylonFileParser>(
        ...
        public static async ValueTask AddIndividualParser(string name, IndividualBabylonFileParser parser)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public static async ValueTask<IndividualBabylonFileParser> GetIndividualParser(string name)
        {
            return await EventHorizonBlazorInterop.FuncClass<IndividualBabylonFileParser>(
