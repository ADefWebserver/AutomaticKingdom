...
__onErrorObservable = null;
        ...
        public async ValueTask<string> executeWhenCompiled(
            Func<Effect, Task> callback
        )
        {
            await SetupExecuteWhenCompiledLoop();
        ...
        private async ValueTask SetupExecuteWhenCompiledLoop()
        {
        ...
        public async ValueTask setTexture(string channel, BaseTexture texture)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public async ValueTask setTextureArray(string channel, BaseTexture[] textures)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
