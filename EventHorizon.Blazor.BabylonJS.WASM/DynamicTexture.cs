...
namespace BabylonJS
{
    ...
    public class DynamicTexture : Texture
    {
        ...
        public async ValueTask drawText(string text, string font, string color, string clearColor, System.Nullable<decimal> x = null, System.Nullable<decimal> y = null, System.Nullable<bool> invertY = null, System.Nullable<bool> update = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
