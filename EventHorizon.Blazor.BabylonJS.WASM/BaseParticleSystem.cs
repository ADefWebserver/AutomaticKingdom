...
__emitter = null;
        ...
        public async ValueTask<Texture> get_particleTexture()
        {
            if(__particleTexture == null)
            {
                __particleTexture = await EventHorizonBlazorInterop.GetClass<Texture>(
                    this.___guid,
                    "particleTexture",
                    (entity) =>
                    {
        ...
        public ValueTask set_particleTexture(Texture value)
        {
