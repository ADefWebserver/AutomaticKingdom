...
__onAfterWorldMatrixUpdateObservable = null;
        ...
        public async ValueTask<string> registerAfterWorldMatrixUpdate(
            Func<TransformNode, Task> callback
        )
        {
            await SetupRegisterAfterWorldMatrixUpdateLoop();
        ...
        private async ValueTask SetupRegisterAfterWorldMatrixUpdateLoop()
        {
        ...
        public async ValueTask<string> unregisterAfterWorldMatrixUpdate(
            Func<TransformNode, Task> callback
        )
        {
            await SetupUnregisterAfterWorldMatrixUpdateLoop();
        ...
        private async ValueTask SetupUnregisterAfterWorldMatrixUpdateLoop()
        {
