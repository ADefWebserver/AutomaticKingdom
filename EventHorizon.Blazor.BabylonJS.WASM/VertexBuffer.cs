...
namespace BabylonJS
{
    ...
    public class VertexBuffer : CachedEntityObject
    {
        ...
        public static async ValueTask ForEach(DataArray data, decimal byteOffset, decimal byteStride, decimal componentCount, decimal componentType, decimal count, bool normalized, ActionCallback<decimal, decimal> callback)
        {
        ...
        public async ValueTask<DataArray> getData()
        {
            return await EventHorizonBlazorInterop.FuncClass<DataArray>(
        ...
        public async ValueTask create(DataArray data = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public async ValueTask update(DataArray data)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public async ValueTask updateDirectly(DataArray data, decimal offset, System.Nullable<bool> useBytes = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
