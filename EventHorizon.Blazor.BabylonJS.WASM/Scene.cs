...
__actionManager = null;
        ...
        public async ValueTask<string> registerBeforeRender(
            Func<Task> callback
        )
        {
            await SetupRegisterBeforeRenderLoop();
        ...
        private async ValueTask SetupRegisterBeforeRenderLoop()
        {
        ...
        public async ValueTask<string> unregisterBeforeRender(
            Func<Task> callback
        )
        {
            await SetupUnregisterBeforeRenderLoop();
        ...
        private async ValueTask SetupUnregisterBeforeRenderLoop()
        {
        ...
        public async ValueTask<string> registerAfterRender(
            Func<Task> callback
        )
        {
            await SetupRegisterAfterRenderLoop();
        ...
        private async ValueTask SetupRegisterAfterRenderLoop()
        {
        ...
        public async ValueTask<string> unregisterAfterRender(
            Func<Task> callback
        )
        {
            await SetupUnregisterAfterRenderLoop();
        ...
        private async ValueTask SetupUnregisterAfterRenderLoop()
        {
        ...
        public async ValueTask<string> executeOnceBeforeRender(
            Func<Task> callback
        )
        {
            await SetupExecuteOnceBeforeRenderLoop();
        ...
        private async ValueTask SetupExecuteOnceBeforeRenderLoop()
        {
        ...
        public async ValueTask<string> executeWhenReady(
            Func<Task> callback
        )
        {
            await SetupExecuteWhenReadyLoop();
        ...
        private async ValueTask SetupExecuteWhenReadyLoop()
        {
        ...
        public async ValueTask<Scene> freezeActiveMeshes(System.Nullable<bool> skipEvaluateActiveMeshes = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<Scene>(
                entity => new Scene() { ___guid = entity.___guid },
                new object[] 
        ...
        public async ValueTask<string> getWorldExtends(
            Func<AbstractMesh, Task> callback
        )
        {
            await SetupGetWorldExtendsLoop();
        ...
        private async ValueTask SetupGetWorldExtendsLoop()
        {
        ...
        public async ValueTask<PickingInfo> pick(decimal x, decimal y, ActionCallback<AbstractMesh> predicate = null, System.Nullable<bool> fastCheck = null, Camera camera = null, TrianglePickingPredicate trianglePredicate = null)
        {
        ...
        public async ValueTask<PickingInfo> pickWithRay(Ray ray, ActionCallback<AbstractMesh> predicate = null, System.Nullable<bool> fastCheck = null, TrianglePickingPredicate trianglePredicate = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<PickingInfo>(
                entity => new PickingInfo() { ___guid = entity.___guid },
                new object[] 
        ...
        public async ValueTask<PickingInfo[]> multiPick(decimal x, decimal y, ActionCallback<AbstractMesh> predicate = null, Camera camera = null, TrianglePickingPredicate trianglePredicate = null)
        {
        ...
        public async ValueTask<PickingInfo[]> multiPickWithRay(Ray ray, ActionCallback<AbstractMesh> predicate, TrianglePickingPredicate trianglePredicate = null)
        {
            return await EventHorizonBlazorInterop.FuncArrayClass<PickingInfo>(
                entity => new PickingInfo() { ___guid = entity.___guid },
                new object[]
        ...
        public async ValueTask setPointerOverMesh(AbstractMesh mesh)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
