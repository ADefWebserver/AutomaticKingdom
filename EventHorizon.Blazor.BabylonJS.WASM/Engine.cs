...
__onAfterShaderCompilationObservable = null;
        ...
        public async ValueTask updateDynamicVertexBuffer(DataBuffer vertexBuffer, DataArray data, System.Nullable<decimal> byteOffset = null, System.Nullable<decimal> byteLength = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public async ValueTask updateDynamicIndexBuffer(DataBuffer indexBuffer, decimal[] indices, System.Nullable<decimal> offset = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
