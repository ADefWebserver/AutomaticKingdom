...
__OnPluginActivatedObservable = null;
        ...
        public static async ValueTask ImportMeshAsync(object meshNames, string rootUrl, string sceneFilename = null, Scene scene = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, string pluginExtension = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public static async ValueTask<ISceneLoaderPluginCachedEntity> Load(string rootUrl, string sceneFilename = null, Engine engine = null, ActionCallback<Scene> onSuccess = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, ActionCallback<Scene, string, CachedEntity> onError = null, string pluginExtension = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<ISceneLoaderPluginCachedEntity>(
                entity => new ISceneLoaderPluginCachedEntity() { ___guid = entity.___guid },
                new object[] 
        ...
        public static async ValueTask LoadAsync(string rootUrl, string sceneFilename = null, Engine engine = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, string pluginExtension = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public static async ValueTask<ISceneLoaderPluginCachedEntity> Append(string rootUrl, string sceneFilename = null, Scene scene = null, ActionCallback<Scene> onSuccess = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, ActionCallback<Scene, string, CachedEntity> onError = null, string pluginExtension = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<ISceneLoaderPluginCachedEntity>(
                entity => new ISceneLoaderPluginCachedEntity() { ___guid = entity.___guid },
                new object[] 
        ...
        public static async ValueTask AppendAsync(string rootUrl, string sceneFilename = null, Scene scene = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, string pluginExtension = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public static async ValueTask LoadAssetContainerAsync(string rootUrl, string sceneFilename = null, Scene scene = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, string pluginExtension = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
        ...
        public static async ValueTask ImportAnimationsAsync(string rootUrl, string sceneFilename = null, Scene scene = null, System.Nullable<bool> overwriteAnimations = null, System.Nullable<int> animationGroupLoadingMode = null, ActionCallback<CachedEntity> targetConverter = null, ActionCallback<Scene> onSuccess = null, ActionCallback<SceneLoaderProgressEvent> onProgress = null, ActionCallback<Scene, string, CachedEntity> onError = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] 
                {
